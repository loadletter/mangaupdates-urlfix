(function () {if(typeof(localStorage) !== "undefined" && !localStorage.getItem('loadletter.urlfix.onlinedeprecated')) {alert("The version of mangaupdates-urlfix you're using is old, if you're getting this message you should probably reinstall it using the latest and faster version from https://github.com/loadletter/mangaupdates-urlfix"); localStorage.setItem('loadletter.urlfix.onlinedeprecated', 'true');} })();
var urlfix_grouplist = {
    ...
    "2999": "https://coffeetranslation.wordpress.com/",
